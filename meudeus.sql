...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Set-2022 às 03:02
...
--
ALTER TABLE `fidelidade`
  MODIFY `id_fidelidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `veiculo`
  MODIFY `id_placa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `agendamento`
  ADD CONSTRAINT `FK_AGENDAMENTO_2` FOREIGN KEY (`FK_CLIENTE_id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_AGENDAMENTO_3` FOREIGN KEY (`FK_VEICULO_id_placa`) REFERENCES `veiculo` (`id_placa`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `veiculo`
  ...
  ADD CONSTRAINT `FK_VEICULO_3` FOREIGN KEY (`FK_CLIENTE_id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
